  ...
  return (
    <Grid gridTemplate={contentTemplate} padding="large">
      ...
      <GridItem gridArea="prev">
        <H3>Preview</H3>
        <Box border="box" display="block" padding="xxLarge" style={{ backgroundColor: searchConfig.bgColor }}>
          <Input iconRight={<SearchIcon color={searchConfig.borderColor} />} placeholder={searchConfig.placeholder} disabled />
        </Box>
      </GridItem>
    </Grid>
  );
